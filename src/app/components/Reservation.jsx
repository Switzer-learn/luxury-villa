            ...
            <form onSubmit={handleEmailSubmit} className="space-y-6">
              ...
              >
                ...
                <input
                  ...
                  required
                  className="input input-bordered px-2 py-1 w-full bg-neutral text-primary focus:border-accent"
              ...
              >
                ...
                <select
                  ...
                  onChange={handleInputChange}
                  className="select select-bordered px-2 py-1 w-full bg-neutral text-primary focus:border-accent"
                >
              ...
              >
                ...
                <textarea
                  ...
                  onChange={handleInputChange}
                  className="textarea textarea-bordered px-2 py-1 w-full h-24 bg-neutral text-primary focus:border-accent resize-none"
              ...
              <motion.div
                ...
                className="flex flex-col sm:flex-row gap-4 pt-4 justify-center align-middle"
              >
                {/* Email Submit */}
                <motion.button
                  type="submit"
                  className="btn rounded-lg p-2 bg-accent hover:bg-accent/80 text-white border-none flex-1"
                ...
                <motion.button
                  ...
                  className="btn btn-outline bg-green-500 rounded-lg p-2 border-green-accent text-white hover:bg-green-accent hover:text-white flex-1"
